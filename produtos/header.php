...
<header class="header-section">
        <div class="header-top">
            <div class="container container-mobile">
                ...
                <div class="ht-right" style="display: flex; flex-direction: row-reverse">
                    <?php
                            ...
                            <div class="advanced-search">
                                <div class="input-group">
                                    <form style="width: 100%">
                                        <input type="text" name='term' placeholder="O que você precisa?">
                                        <button type="submit" name='search-btn'><i class="ti-search"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
